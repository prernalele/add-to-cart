...
const OrderConfirmationForm = ({ itemsInCart, setShowOrderConfirmed }) => {
  return (
    <div className=" fixed inset-0 z-50 bg-black/50 flex flex-col items-center justify-center  ">
      <div className="bg-rose-50 h-[50%] w-[30%] justify-around rounded-2xl min-h-dvh">
        ...
        <button
          className="bg-rose-200 text-black justify-center text-xl p-2 m-2 rounded-xl font-medium hover:bg-rose-300 hover:transition-300"
